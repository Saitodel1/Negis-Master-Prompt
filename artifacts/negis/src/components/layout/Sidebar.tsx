...
import { BarChart2, CalendarDays, Building2, Briefcase, Settings, LogOut, X, Check, KeyRound, User, Megaphone, ClipboardList } from 'lucide-react';
...
const NAV = [
  ...
  { href: '/sales',     icon: Briefcase,    label: 'Clients',  roles: ['owner', 'manager', 'agent'] },
  { href: '/tasks',     icon: ClipboardList, label: 'Tasks',   roles: ['owner', 'manager', 'agent'] },
